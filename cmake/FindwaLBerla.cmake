set (WALBERLA_FOUND
     OFF
     CACHE BOOL "waLBerla found"
)
set (WALBERLA_DIR
     WALBERLA_DIR-NOTFOUND
     CACHE PATH "waLBerla path"
)
...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/walberla")
    ...
    waLBerla_import ()
    set (WALBERLA_DIR
         "${CMAKE_CURRENT_SOURCE_DIR}/walberla"
         CACHE PATH "waLBerla path" FORCE
    )
    set (WALBERLA_FOUND
         ON
         CACHE BOOL "waLBerla found" FORCE
    )
else()
