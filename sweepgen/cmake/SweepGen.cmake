...
#   SweepGen Runtime Library

add_library( walberla_sweepgen INTERFACE )
add_library( walberla::sweepgen ALIAS walberla_sweepgen )
...
if( WALBERLA_BUILD_WITH_GPU )
    target_link_libraries( walberla_sweepgen INTERFACE walberla_gpu )
endif()

if( WALBERLA_BUILD_WITH_CUDA )
    set(_sweepgen_default_extension ".cu")
elseif( WALBERLA_BUILD_WITH_HIP )
    set(_sweepgen_default_extension ".hip")
else()
    set(_sweepgen_default_extension ".cpp")
endif()

set(
    SWEEPGEN_DEFAULT_EXTENSION
    ${_sweepgen_default_extension}
    CACHE INTERNAL "Default file extensions for TUs generated by SweepGen"
)
...
function(walberla_generate_sources TARGET)
    ...
    pystencilssfg_generate_target_sources(
        ...
        CONFIG_MODULE $CACHE{WALBERLA_CODEGEN_CONFIG_MODULE}
        ${_extraArgs}
    )
