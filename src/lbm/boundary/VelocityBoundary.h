...
template< typename LatticeModel_T, typename flag_t >
inline void VelocityBoundary< LatticeModel_T, flag_t >::treatDirection( [[maybe_unused]] const cell_idx_t  x, [[maybe_unused]] const cell_idx_t  y, [[maybe_unused]] const cell_idx_t  z, const stencil::Direction dir,
