...
struct D3Q15
{
   ...
   static constexpr std::string_view NAME = "D3Q15";

   static constexpr uint_t D = 3;
   static constexpr uint_t Q = 15;

   static constexpr uint_t POS_Q = 15 / 2;

   static constexpr uint_t Dimension = 3;
   static constexpr uint_t Size      = 15;
    ...
    */
   static constexpr std::array< Direction, 15 > dir = { C,N,S,W,E,T,B,TNE,TNW,TSE,TSW,BNE,BNW,BSE,BSW };
    ...
    */
   static constexpr std::array< Direction, POS_Q > dir_pos = { N,E,T,TNE,TSE,BNE,BSE };
    ...
    */
   static constexpr std::array< uint_t, NR_OF_DIRECTIONS > idx = { 0,1,2,3,4,5,6,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,7,8,9,10,11,12,13,14 };
   ...
   *
   */
   static constexpr std::array< std::array< Direction, 15 / 2 >, NR_OF_DIRECTIONS > d_per_d { { {C},
								{N,TNE,TNW,BNE,BNW},
								{S,TSE,TSW,BSE,BSW},
								{W,TNW,TSW,BNW,BSW},
								{E,TNE,TSE,BNE,BSE},
    ...
    */
   static constexpr std::array< std::array< Direction, NR_OF_DIRECTIONS >, NR_OF_DIRECTIONS > dir_neighbors { { {N,S,W,E,T,B,TNE,TNW,TSE,TSW,BNE,BNW,BSE,BSW},
    ...
    */
   static constexpr std::array< uint_t, NR_OF_DIRECTIONS > dir_neighbors_length { 14,9,9,9,9,9,9,6,6,6,6,6,6,6,6,6,6,6,6,4,4,4,4,4,4,4,4 };
   ...
   static constexpr iterator end() { return iterator(15); }
