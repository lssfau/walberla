   ...
   namespace internal
   {
      ...
      */
      ...
      struct D3Q6
      {
         ...
         static const uint_t Q = 6;

         static const uint_t POS_Q = 6 / 2;

         static const uint_t Dimension = 3;
         static const uint_t Size      = 6;
         ...
         static iterator end()             { return iterator(6); }
      ...
      template<typename Dummy> const uint_t D3Q6<Dummy>::D;
      template<typename Dummy> const uint_t D3Q6<Dummy>::Q;
      template<typename Dummy> const uint_t D3Q6<Dummy>::POS_Q;
      template<typename Dummy> const uint_t D3Q6<Dummy>::Dimension;
      template<typename Dummy> const uint_t D3Q6<Dummy>::Size;
      template<typename Dummy> const bool   D3Q6<Dummy>::containsCenter;
      template<typename Dummy> const uint_t D3Q6<Dummy>::noCenterFirstIdx;

      template<typename Dummy> const char * D3Q6<Dummy>::NAME = "D3Q6";
