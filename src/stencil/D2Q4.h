...
namespace stencil {
   ...
   namespace internal
   {
      ...
      */
      ...
      template<typename Dummy> const uint_t D2Q4<Dummy>::D;
      template<typename Dummy> const uint_t D2Q4<Dummy>::Q;
      template<typename Dummy> const uint_t D2Q4<Dummy>::POS_Q;
      template<typename Dummy> const uint_t D2Q4<Dummy>::Dimension;
      template<typename Dummy> const uint_t D2Q4<Dummy>::Size;
      template<typename Dummy> const bool   D2Q4<Dummy>::containsCenter;
      template<typename Dummy> const uint_t D2Q4<Dummy>::noCenterFirstIdx;

      template<typename Dummy> const char * D2Q4<Dummy>::NAME = "D2Q4";
