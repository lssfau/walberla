...
\code
  ...
  for( uint_t i = 0; i < D2Q4::Size; ++i )
  {
     int cx = cx[ D2Q4::dir[i] ];
     Direction inverse = inverseDir[ D2Q4::dir[i] ];
  }
\endcode
*
...
\code
  using namespace stencil;
  for( auto dir = D2Q4::begin(); dir != D2Q4::end(); ++dir )
  {
    int cx = dir.cx();
...
struct D2Q4
{
   ...
   static constexpr std::string_view NAME = "D2Q4";

   static constexpr uint_t D = 2;
   static constexpr uint_t Q = 4;

   static constexpr uint_t POS_Q = 4 / 2;

   static constexpr uint_t Dimension = 2;
   static constexpr uint_t Size      = 4;
    ...
    */
   static constexpr std::array< Direction, 4 > dir = { N,S,W,E };
    ...
    */
   static constexpr std::array< uint_t, NR_OF_DIRECTIONS > idx = { INVALID_DIR,0,1,2,3,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR,INVALID_DIR };
   ...
   *
   */
   static constexpr std::array< std::array< Direction, 4 / 2 >, NR_OF_DIRECTIONS > d_per_d { { {},
								{N},
								{S},
								{W},
								{E},
   ...
   static constexpr iterator end() { return iterator(4); }
