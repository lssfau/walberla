...
//
//! \file VectorFieldDisplayAdaptor.h
//! \ingroup gui
...
namespace gui {
   ...
   */
   ...
   class VectorFieldDisplayAdaptor : public FieldDisplayAdaptor< field_t >
   {
   public:
      typedef typename field_t::value_type::value_type T;
      typedef FieldDisplayAdaptor< field_t > base_t;
      typedef typename Vector3<T>::Length    length_t;
...
#include "VectorFieldDisplayAdaptor.impl.h"
