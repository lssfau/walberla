...
namespace communication {
   ...
   public:
      ...
      inline std::size_t allocSize() const { return static_cast< std::size_t >(end_ - begin_); }
      inline std::size_t size() const { return static_cast< std::size_t >(cur_ - begin_); }
      inline std::size_t remainingSize() const { return static_cast< std::size_t >(end_ - cur_); }
