...
//
//! \file ParticleAndVolumeFractionMappingCPU.h
...
class SphereFractionMapping
{
 public:
   SphereFractionMapping(const shared_ptr< StructuredBlockStorage >& blockStorage,
                         const shared_ptr< ParticleAccessor_T >& ac, const ParticleSelector_T& mappingParticleSelector,
