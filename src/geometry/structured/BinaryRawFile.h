...
{
   uint_t const xInt = uint_c( (x - aabb_.xMin()) / aabb_.xSize() * static_cast< real_t >( binaryRawFile_.size()[0] ) + real_t{ 0.5 } );
   uint_t const yInt = uint_c( (y - aabb_.yMin()) / aabb_.ySize() * static_cast< real_t >( binaryRawFile_.size()[1] ) + real_t{ 0.5 } );
   uint_t const zInt = uint_c( (z - aabb_.zMin()) / aabb_.zSize() * static_cast< real_t >( binaryRawFile_.size()[2] ) + real_t{ 0.5 } );
